...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l1_l3_i2) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l3_i2)) (mapped l1 ?p1) (occupied_pqubit ?p1) (mapped l3 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l0_l3_i5
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l1_l3_i2)) (mapped l3 ?p2) (rcnot l0_l3_i5) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l3_i5)) (mapped l0 ?p1) (occupied_pqubit ?p1))
)
(:action apply_cnot_l4_l0_i8
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l0_l3_i5)) (mapped l0 ?p2) (rcnot l4_l0_i8) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l0_i8)) (mapped l4 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l0_l3_i17)) (mapped l3 ?p2) (rcnot l2_l3_i19) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l3_i19)) (mapped l2 ?p1) (occupied_pqubit ?p1))
)
