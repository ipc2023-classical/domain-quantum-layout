...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l0_l2_i0) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l2_i0)) (mapped l0 ?p1) (occupied_pqubit ?p1) (mapped l2 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l3_l2_i4)) (mapped l3 ?p2) (rcnot l4_l3_i8) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l3_i8)) (mapped l4 ?p1) (occupied_pqubit ?p1))
)
