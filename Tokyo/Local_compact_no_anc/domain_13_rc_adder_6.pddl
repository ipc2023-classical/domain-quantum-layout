...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l4_l3_i0) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l3_i0)) (mapped l4 ?p1) (occupied_pqubit ?p1) (mapped l3 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l4_l2_i1
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l4_l3_i0)) (mapped l4 ?p1) (not (occupied_pqubit ?p2)) (rcnot l4_l2_i1) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l2_i1)) (mapped l2 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l1_l2_i3
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l4_l2_i1)) (mapped l2 ?p2) (rcnot l1_l2_i3) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l2_i3)) (mapped l1 ?p1) (occupied_pqubit ?p1))
)
(:action apply_cnot_l0_l2_i5
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l1_l2_i3)) (mapped l2 ?p2) (rcnot l0_l2_i5) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l2_i5)) (mapped l0 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l6_l5_i12) (connected ?p1 ?p2))
:effect (and (not (rcnot l6_l5_i12)) (mapped l6 ?p1) (occupied_pqubit ?p1) (mapped l5 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l8_l7_i25) (connected ?p1 ?p2))
:effect (and (not (rcnot l8_l7_i25)) (mapped l8 ?p1) (occupied_pqubit ?p1) (mapped l7 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l10_l9_i38) (connected ?p1 ?p2))
:effect (and (not (rcnot l10_l9_i38)) (mapped l10 ?p1) (occupied_pqubit ?p1) (mapped l9 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l12_l11_i51) (connected ?p1 ?p2))
:effect (and (not (rcnot l12_l11_i51)) (mapped l12 ?p1) (occupied_pqubit ?p1) (mapped l11 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l12_l10_i53)) (mapped l12 ?p1) (not (occupied_pqubit ?p2)) (rcnot l12_l13_i66) (connected ?p1 ?p2))
:effect (and (not (rcnot l12_l13_i66)) (mapped l13 ?p2) (occupied_pqubit ?p2))
)
