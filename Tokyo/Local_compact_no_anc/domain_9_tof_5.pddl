...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l1_l5_i1) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l5_i1)) (mapped l1 ?p1) (occupied_pqubit ?p1) (mapped l5 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l0_l5_i3
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l1_l5_i1)) (mapped l5 ?p2) (rcnot l0_l5_i3) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l5_i3)) (mapped l0 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l0_l5_i7)) (mapped l5 ?p1) (not (occupied_pqubit ?p2)) (rcnot l5_l6_i11) (connected ?p1 ?p2))
:effect (and (not (rcnot l5_l6_i11)) (mapped l6 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l2_l6_i13
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l5_l6_i11)) (mapped l6 ?p2) (rcnot l2_l6_i13) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l6_i13)) (mapped l2 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l2_l6_i17)) (mapped l6 ?p1) (not (occupied_pqubit ?p2)) (rcnot l6_l7_i21) (connected ?p1 ?p2))
:effect (and (not (rcnot l6_l7_i21)) (mapped l7 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l3_l7_i23
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l6_l7_i21)) (mapped l7 ?p2) (rcnot l3_l7_i23) (connected ?p1 ?p2))
:effect (and (not (rcnot l3_l7_i23)) (mapped l3 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l3_l7_i27)) (mapped l7 ?p1) (not (occupied_pqubit ?p2)) (rcnot l7_l8_i31) (connected ?p1 ?p2))
:effect (and (not (rcnot l7_l8_i31)) (mapped l8 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l4_l8_i33
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l7_l8_i31)) (mapped l8 ?p2) (rcnot l4_l8_i33) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l8_i33)) (mapped l4 ?p1) (occupied_pqubit ?p1))
)
