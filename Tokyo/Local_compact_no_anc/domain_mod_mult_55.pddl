...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l0_l7_i2) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l7_i2)) (mapped l0 ?p1) (occupied_pqubit ?p1) (mapped l7 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l2_l7_i4
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l0_l7_i2)) (mapped l7 ?p2) (rcnot l2_l7_i4) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l7_i4)) (mapped l2 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l2_l7_i8)) (mapped l7 ?p1) (not (occupied_pqubit ?p2)) (rcnot l7_l6_i15) (connected ?p1 ?p2))
:effect (and (not (rcnot l7_l6_i15)) (mapped l6 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l1_l6_i17
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l7_l6_i15)) (mapped l6 ?p2) (rcnot l1_l6_i17) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l6_i17)) (mapped l1 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l1_l6_i21)) (mapped l6 ?p1) (not (occupied_pqubit ?p2)) (rcnot l6_l5_i25) (connected ?p1 ?p2))
:effect (and (not (rcnot l6_l5_i25)) (mapped l5 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l6_l3_i26
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l6_l5_i25)) (mapped l6 ?p1) (not (occupied_pqubit ?p2)) (rcnot l6_l3_i26) (connected ?p1 ?p2))
:effect (and (not (rcnot l6_l3_i26)) (mapped l3 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l2_l0_i12)) (mapped l2 ?p1) (not (occupied_pqubit ?p2)) (rcnot l2_l8_i33) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l8_i33)) (mapped l8 ?p2) (occupied_pqubit ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l1_l6_i51)) (mapped l6 ?p1) (not (occupied_pqubit ?p2)) (rcnot l6_l4_i55) (connected ?p1 ?p2))
:effect (and (not (rcnot l6_l4_i55)) (mapped l4 ?p2) (occupied_pqubit ?p2))
)
