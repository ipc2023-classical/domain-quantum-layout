...
:precondition (and  (not (initialized ?p1)) (not (initialized ?p2)) (rcnot l0_l1_i2) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l1_i2)) (mapped l0 ?p1) (occupied_pqubit ?p1) (initialized ?p1) (mapped l1 ?p2) (occupied_pqubit ?p2) (initialized ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l0_l1_i4)) (mapped l1 ?p1) (not (initialized ?p2)) (rcnot l1_l2_i7) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l2_i7)) (mapped l2 ?p2) (occupied_pqubit ?p2) (initialized ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l1_l2_i9)) (mapped l2 ?p1) (not (initialized ?p2)) (rcnot l2_l3_i12) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l3_i12)) (mapped l3 ?p2) (occupied_pqubit ?p2) (initialized ?p2))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l2_l3_i14)) (mapped l3 ?p1) (not (initialized ?p2)) (rcnot l3_l4_i17) (connected ?p1 ?p2))
:effect (and (not (rcnot l3_l4_i17)) (mapped l4 ?p2) (occupied_pqubit ?p2) (initialized ?p2))
)
