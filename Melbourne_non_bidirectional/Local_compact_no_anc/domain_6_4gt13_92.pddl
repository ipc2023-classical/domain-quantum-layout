...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l2_l3_i3) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l3_i3)) (mapped l2 ?p1) (occupied_pqubit ?p1) (mapped l3 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l4_l0_i4
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l4_l0_i4) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l0_i4)) (mapped l4 ?p1) (occupied_pqubit ?p1) (mapped l0 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l4_l1_i8
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and (not (rcnot l4_l0_i4)) (mapped l4 ?p1) (not (occupied_pqubit ?p2)) (rcnot l4_l1_i8) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l1_i8)) (mapped l1 ?p2) (occupied_pqubit ?p2))
)
