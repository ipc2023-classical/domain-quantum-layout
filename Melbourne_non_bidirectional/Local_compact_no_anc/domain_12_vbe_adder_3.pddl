...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l2_l3_i1) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l3_i1)) (mapped l2 ?p1) (occupied_pqubit ?p1) (mapped l3 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l1_l3_i3
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l2_l3_i1)) (mapped l3 ?p2) (rcnot l1_l3_i3) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l3_i3)) (mapped l1 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l2_l3_i8)) (mapped l3 ?p2) (rcnot l0_l3_i9) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l3_i9)) (mapped l0 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l5_l6_i17) (connected ?p1 ?p2))
:effect (and (not (rcnot l5_l6_i17)) (mapped l5 ?p1) (occupied_pqubit ?p1) (mapped l6 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l4_l6_i19
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l5_l6_i17)) (mapped l6 ?p2) (rcnot l4_l6_i19) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l6_i19)) (mapped l4 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l8_l9_i36) (connected ?p1 ?p2))
:effect (and (not (rcnot l8_l9_i36)) (mapped l8 ?p1) (occupied_pqubit ?p1) (mapped l9 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l7_l9_i38
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l8_l9_i36)) (mapped l9 ?p2) (rcnot l7_l9_i38) (connected ?p1 ?p2))
:effect (and (not (rcnot l7_l9_i38)) (mapped l7 ?p1) (occupied_pqubit ?p1))
)
