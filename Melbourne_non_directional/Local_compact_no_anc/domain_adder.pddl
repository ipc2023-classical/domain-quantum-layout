...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l0_l1_i4) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l1_i4)) (mapped l0 ?p1) (occupied_pqubit ?p1) (mapped l1 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l2_l3_i6
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l2_l3_i6) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l3_i6)) (mapped l2 ?p1) (occupied_pqubit ?p1) (mapped l3 ?p2) (occupied_pqubit ?p2))
)
