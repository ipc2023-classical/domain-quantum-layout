...
:precondition (and  (not (occupied_pqubit ?p1)) (not (occupied_pqubit ?p2)) (rcnot l5_l6_i3) (connected ?p1 ?p2))
:effect (and (not (rcnot l5_l6_i3)) (mapped l5 ?p1) (occupied_pqubit ?p1) (mapped l6 ?p2) (occupied_pqubit ?p2))
)
(:action apply_cnot_l3_l6_i5
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l5_l6_i3)) (mapped l6 ?p2) (rcnot l3_l6_i5) (connected ?p1 ?p2))
:effect (and (not (rcnot l3_l6_i5)) (mapped l3 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l3_l5_i10)) (mapped l5 ?p2) (rcnot l4_l5_i12) (connected ?p1 ?p2))
:effect (and (not (rcnot l4_l5_i12)) (mapped l4 ?p1) (occupied_pqubit ?p1))
)
(:action apply_cnot_l2_l5_i14
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l4_l5_i12)) (mapped l5 ?p2) (rcnot l2_l5_i14) (connected ?p1 ?p2))
:effect (and (not (rcnot l2_l5_i14)) (mapped l2 ?p1) (occupied_pqubit ?p1))
)
...
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l2_l4_i19)) (mapped l4 ?p2) (rcnot l1_l4_i21) (connected ?p1 ?p2))
:effect (and (not (rcnot l1_l4_i21)) (mapped l1 ?p1) (occupied_pqubit ?p1))
)
(:action apply_cnot_l0_l4_i23
:parameters (?p1 - pqubit ?p2 - pqubit)
:precondition (and  (not (occupied_pqubit ?p1)) (not (rcnot l1_l4_i21)) (mapped l4 ?p2) (rcnot l0_l4_i23) (connected ?p1 ?p2))
:effect (and (not (rcnot l0_l4_i23)) (mapped l0 ?p1) (occupied_pqubit ?p1))
)
